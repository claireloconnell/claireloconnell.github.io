...
| [Julian C. Evan's Website]([https://igraph.org/r/](https://jevansbio.wordpress.com/2019/05/07/an-igraph-hack/))  | Igraph, examples, plotting aesthetics  | Moderate | Dr. Evan's igraph arrow size hack is useful if you want to customize the size of your edge arrows (igraph defaults to a standard arrow size which can look awkward with certain edge widths or node sizes). They have a few other network resources that you might find useful! |
